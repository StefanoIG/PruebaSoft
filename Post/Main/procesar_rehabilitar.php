...
$query = "UPDATE departamento SET estado = 'en proceso' WHERE id_departamento = :id_departamento";
...
if ($stmt->execute(['id_departamento' => $idDepartamento])) {
    ...
    echo "Rehabilitado con exito.";
} else {
    echo "Error al actualizar el estado del departamento.";
}